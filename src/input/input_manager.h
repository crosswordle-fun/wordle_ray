...
static inline GameState input_system(GameState state) {
...
static inline GameState home_screen_input_system(GameState state) {
...
static inline GameState crossword_completion_input_system(GameState state) {
