...
static inline void spawn_particles(GameState* state, Vector2 position, Color color, int count) {
...
static inline void update_particles(GameState* state, float frame_time) {
